...
- **Material-UI 7** for beautiful, responsive design with custom theme
...
- **React Router 7** for client-side navigation with HashRouter
...
│   │   │   ├── ThemeSnackbar.jsx # Notifications
